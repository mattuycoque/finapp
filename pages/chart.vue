...
import { averageLine, baseSeriesItemStyle, options } from '~/components/stat/chartOprions'
import { getCatsIds, getTransferCatgoryIds } from '~/components/categories/getCategories'
